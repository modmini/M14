...
Creator="u1ce6938939bb8f252dd48b8d062ee7d6"
admin=["u1ce6938939bb8f252dd48b8d062ee7d6"]
	        ...
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    ...
                    if len(dataResult) > 0:
                        ...
                        total = '\n\nคนอ่านทั้งหมด %i คน (%s)' % (len(dataResult), datetime.now().strftime('%H:%M:%S') )
...
#--------------------------------------------------------
		...
		cl.sendText(msg.to,"ลบแชตหมดแล้วครับ")
#--------------------------------------------------------
            elif ("Gn: " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
...
#--------------------------------------------------------
		...
		gid = cl.getGroupIdsJoined()
		for i in gid:
		    cl.sendText(i,"🔒[ข้อความนี้เป็นข้อความอัตโนมัติ]\n\n"+bc+"\n\n👥สนใจติดต่อสอบถาม 📲: line://ti/p/~aec4455")
		cl.sendText(msg.to,"ส่งข้อความสำเร็จ🎉🎉")
#--------------------------------------------------------
